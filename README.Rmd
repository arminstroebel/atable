...
arthritis$score2 <- arthritis$score
arthritis$age2 <- arthritis$age
class(arthritis$score2) <- c("numeric2", class(arthritis$score2))
class(arthritis$age2) <- c("numeric2", class(arthritis$age2))
...
names(arthritis)
atable(score + score2 + age + age2 ~ trt, arthritis)
```
